                                ...
                                <div class="js_scene_picture">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <select class="inpit-medium js_scene_style_select" name="m_type" data-rule-required="true">
                                                <option value="1" data-type="first" <?php  if($item['m_type']==1) { ?>selected<?php  } ?>>场景1(单独图片)</option>
                                                <option value="2" data-type="second" <?php  if($item['m_type']==2) { ?>selected<?php  } ?>>场景2(招聘信息)</option>
									...
									<div class="control-group js_scene_style js_second hide">									
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="str1" class="input-large" name="second[str1]" value="<?php  echo $data['str1'];?>"  placeholder="姓名" />
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="str2" class="input-large" name="second[str2]"   value="<?php  echo $data['str2'];?>"  placeholder="电话" />
												<span class="maroon">*</span><span class="help-inline">(为空,不显示)</span>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="str3" class="input-large" name="second[str3]"  value="<?php  echo $data['str3'];?>"  placeholder="岗位" />
												<span class="maroon">*</span><span class="help-inline">(为空,不显示)</span>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="btxt" class="input-large" name="second[btxt]"  value="<?php  echo $data['btxt'];?>"  placeholder="按钮文字" />
