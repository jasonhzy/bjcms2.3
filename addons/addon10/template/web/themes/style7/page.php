                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="inpit-medium js_scene_style_select" name="m_type" data-rule-required="true">
                                                <option value="1" data-type="pure" <?php  if($item['m_type']==1) { ?>selected<?php  } ?>>纯图片式</option>
                                                ...
                                                <option value="4" data-type="video" <?php  if($item['m_type']==4) { ?>selected<?php  } ?>>优酷视频</option>
