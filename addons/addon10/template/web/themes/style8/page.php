...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&amp;ak=359042E5AC9ced07c553ebe2042aad73"></script>    <div id="main">
                              ...
                              <div class="box-content">
                                ...
                                <div class="js_scene_picture">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="inpit-medium js_scene_style_select" name="m_type" data-rule-required="true">
                                                <option value="5" data-type="pic" <?php  if($item['m_type']==5) { ?>selected<?php  } ?>>普通图片</option>
												<option value="1" data-type="pure" <?php  if($item['m_type']==1) { ?>selected<?php  } ?>>图片放大式</option>
                                                <option value="2" data-type="btn" <?php  if($item['m_type']==2) { ?>selected<?php  } ?>>带链接图片式</option>
                                                <option value="3" data-type="share" <?php  if($item['m_type']==3) { ?>selected<?php  } ?>>带分享图片式</option>
												<option value="7" data-type="tel" <?php  if($item['m_type']==7) { ?>selected<?php  } ?>>带拨号图片式</option>
												<option value="6" data-type="pics" <?php  if($item['m_type']==6) { ?>selected<?php  } ?>>多图展示</option>
												<option value="31" data-type="maplink" <?php  if($item['m_type']==31) { ?>selected<?php  } ?>>地图链接</option>
											</select>
                                        </div>
                                    </div>
									<div class="control-group alert js_scene_style js_pic hide">
									场景1：单一图片显示,建议大小640*1008,或者相同比例。(具体参考实例)
									</div>
									<div class="control-group alert js_scene_style js_pure hide">
									场景2：单一图片显示,建议大小640*1008,或者相同比例。(具体参考实例)
									</div>
									<div class="control-group alert alert-success js_scene_style js_btn hide">
									场景3：图片全屏显示,建议大小640*1008,或者相同比例。中下部有按钮图片实现连接(具体参考实例)
									</div>
									<div class="control-group alert alert-info js_scene_style js_share hide">
									场景4：图片全屏显示,建议大小640*1008,或者相同比例。中下部有按钮图片点击出现分享图片(具体参考实例)
									</div>
									<div class="control-group alert alert-error js_scene_style js_tel hide">
									场景5：图片全屏显示,建议大小640*1008,或者相同比例。实现一键拨号(具体参考实例)
									</div>
									<div class="control-group alert js_scene_style js_video hide">
									场景6：图片全屏显示,建议大小640*1008,或者相同比例。优酷视频播放(具体参考实例)
									</div> 
									<div class="control-group alert js_scene_style js_maplink hide">
									场景7：图片全屏显示,建议大小640*1008,或者相同比例。实现百度导航(具体参考实例)
									</div> 
									<div class="control-group alert js_scene_style js_pics hide">
									场景8：图片全屏显示,建议大小640*1008,或者相同比例。多图展示(具体参考实例)
									</div> 
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="js_scene_style js_btn hide">
                                                <div class="margin-top10">
													<input type="text" class="input-xlarge" name="btn[str]" value="<?php  echo $data['str'];?>" placeholder="链接文字" data-rule-required="true"/>
													<span class="help-block">链接文字</span>
                                                 </div>
                                            ...
                                            <div class="js_scene_style js_share hide">
                                                <div class="margin-top10">
													<input type="text" class="input-xlarge" name="share[str]" value="<?php  echo $data['str'];?>" placeholder="链接文字" data-rule-required="true"/>
													<span class="help-block">分享链接文字</span>
												</div>
                                            </div>
                                            <!--分享结束-->
											<!--电话按钮开始-->
                                            <div class="js_scene_style js_tel hide">
                                                <div class="margin-top10">
													<input type="text" class="input-xlarge" name="tel[str]" value="<?php  echo $data['str'];?>" placeholder="链接文字" data-rule-required="true"/>
													<span class="help-block">电话链接文字</span>
                                                 </div>
                                            </div>
                                            <!--按钮结束-->
									...
									<div class="control-group js_scene_style js_tel hide">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="input-xlarge" name="tel[url]" value="<?php  echo $data['url'];?>" placeholder="请输入电话号码" data-rule-required="true" data-rule-phone="true"/>
                                            <span class="help-block">请填写真实的电话号码</span>
                                        </div>
									</div>
 										<div class="control-group js_scene_style js_maplink hide">
										<div class="control-group">
											<label for="" class="control-label">地图文字：</label>
											<div class="controls">
												<input type="text" class="input-xlarge" name="maplink[str]" value="<?php  echo $data['str'];?>" placeholder="链接地图文字" data-rule-required="true"/>
												<span class="help-block">地图链接文字</span>
											</div>
										</div>
										<div class="control-group">
