	 ...
	 <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                                ...
                                                <option value="2" <?php echo $scene['first_type']==2?'selected':'';?> >刮卡图片式</option>
                                             </select>
										</div>
									</div>
													...
													<div class="form-group" id="first_type_1">
										<label class="col-sm-2 control-label no-padding-left" >画面内容：</label>
										...
										<div class="col-sm-9">
															 ...
															 <div class="fileupload fileupload-new" data-provides="fileupload">
			                        <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
			                        	 <?php  if(!empty($scene['cover'])) { ?>
			                            <img style="width:100%" src="<?php echo WEBSITE_ROOT;?>/attachment/<?php  echo $scene['cover'];?>" alt="" onerror="$(this).remove();">
			                              <?php  } ?>
			                            </div>
			                        <div>
			                         <input name="cover" id="cover" type="file"  />
			                            <a href="#" class="fileupload-exists" data-dismiss="fileupload">移除图片</a>
			                            	 <?php  if(!empty($scene['cover'])) { ?>
			                              <input name="cover_del" id="cover_del" type="checkbox" value="1" />删除已上传图片
			                                 <?php  } ?>
			                        </div>
			                    </div>
												...
												<div class="form-group"  id="first_type_2">
										<label class="col-sm-2 control-label no-padding-left" >擦一擦文字：</label>

										<div class="col-sm-9">
												
													<input type="text" name="cover_title" class="col-xs-10 col-sm-3" value="<?php echo $scene['cover_title'];?>" />
										</div>
									</div>
									
									
													<div class="form-group" id="first_type_3">
			                              ...
			                              <input name="cover1_del" id="cover1_del" type="checkbox" value="1" />删除已上传图片
			                                 <?php  } ?>
											    ...
											    <div class="help-block">建议尺寸:宽640像素,高960像素或等比图片</div>
														...
														<div class="form-group" id="first_type_4">
...
<script>
										...
										function change_first_type(val)
										{
										if(val==1)
										{
											document.getElementById('first_type_1').style.display='block';
													document.getElementById('first_type_2').style.display='none';
													
													document.getElementById('first_type_3').style.display='none';
													
													document.getElementById('first_type_4').style.display='none';
										}
											
												if(val==2)
										{
												document.getElementById('first_type_1').style.display='none';
													document.getElementById('first_type_2').style.display='block';
													
													document.getElementById('first_type_3').style.display='block';
													
													document.getElementById('first_type_4').style.display='block';
										}
										}
										
										change_first_type(<?php  echo empty($scene['first_type'])?'1':$scene['first_type'];?>);
