			...
			<tbody id="listTable">
				<?php  if(empty($data['thumbs'])) { ?>
					<tr class="copy_rows">
						...
						<input type="hidden" value="<?php  echo $data['mthumb'];?>" name="t2pics[nails][]" />
						...
						<div id="map_image_uploads" class="">
						<img upload="image-single" style="max-height:50px;" src="" />
						<input type="hidden" value="<?php  echo $data['mthumb'];?>" name="t2pics[thumbs][]" />
				...
				<?php  } else { ?>	
					...
					<td>
						...
						<input type="hidden" value="<?php  echo $data['nails'][$key];?>" name="t2pics[nails][]"/>
					...
					<td>
						...
						<input type="hidden" value="<?php  echo $row;?>" name="t2pics[thumbs][]" />
