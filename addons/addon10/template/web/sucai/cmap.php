<div class="control-group js_scene_style js_cmap hide">
		<div class="control-group">
			...
			<div class="controls">
				<div id="btn_img_image_uploads" class="">
					...
					<input type="hidden" value="<?php  echo $data['btnimg'];?>" name="cmap[btnimg]" />
		...
		<div class="control-group">
			...
			<div class="margin-top10">
				<div id="btn_img_image_uploads" class="">
					...
					<input type="hidden" value="<?php  echo $data['txtbg'];?>" name="cmap[txtbg]" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="sname" class="input-large" name="cmap[sname]" value="<?php  echo $data['sname'];?>"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append">
					<input type="text" id="suggestId" class="input-xlarge" name="cmap[place]" data-rule-required="true"  value="<?php  echo $data['place'];?>"/>
				...
				<div id="r-result">
					<input type="hidden" id="lng" name="cmap[lng]" value="<?php  echo $data['lng'];?>" /><input type="hidden" id="lat" name="cmap[lat]" value="<?php  echo $data['lat'];?>"  />
				</div>
			</div>
		</div>
	</div>