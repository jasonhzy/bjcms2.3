<div class="control-group js_scene_style js_amap hide">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="wxurl" class="input-xxlarge" name="amap[wxurl]" value="<?php  echo $data['wxurl'];?>"/>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="weixin" class="input-large" name="amap[weixin]" value="<?php  echo $data['weixin'];?>"/>
			<span class="maroon">*</span><span class="help-inline">(为空,不显示)</span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="margin-top10 controls">
			...
			<input type="hidden" value="<?php  echo $data['mthumb'];?>" name="amap[mthumb]"  />
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="sname" class="input-large" name="amap[sname]" value="<?php  echo $data['sname'];?>"/>
	...
	<div class="control-group">
		...
		<div class="controls">
			<div class="input-append">
				<input type="text" id="suggestId" class="input-xlarge" name="amap[place]" data-rule-required="true"  value="<?php  echo $data['place'];?>"/>
			...
			<div id="r-result">
				<input type="hidden" id="lng" name="amap[lng]" value="<?php  echo $data['lng'];?>" /><input type="hidden" id="lat" name="amap[lat]" value="<?php  echo $data['lat'];?>"  />
			</div>
		</div>
	</div>
</div>