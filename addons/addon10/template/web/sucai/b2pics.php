			...
			<tbody id="listTable2">
				<?php  if(empty($data['thumbs'])) { ?>
					<tr class="copy_rows2">
						...
						<img upload="image-single" style="max-height:50px;" src="<?php  echo $this->toimage($b2pics['mthumb']) ?>" />
						<input type="hidden" value="<?php  echo $data['mthumb'];?>" name="b2pics[nails][]" id="mapimage" />
						...
						<div id="map_image_uploads" class="">
						<img upload="image-single" style="max-height:50px;" src="<?php  echo $this->toimage($b2pics['mthumb']) ?>" />
						<input type="hidden" value="<?php  echo $data['mthumb'];?>" name="b2pics[thumbs][]" id="mapimage" />
				...
				<?php  } else { ?>	
					...
					<td>
						...
						<input type="hidden" value="<?php  echo $data['nails'][$key];?>" name="b2pics[nails][]" id="mapimage" />
					...
					<td>
						...
						<input type="hidden" value="<?php  echo $row;?>" name="b2pics[thumbs][]" id="mapimage" />
